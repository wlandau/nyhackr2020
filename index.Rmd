...
## drake's dynamic branching has performance limitations
...
## Parallel efficient dynamic branching in targets
...
1. Verify that in 90% of the simulation reps, the $\beta$ parameter values used for data generation are covered in 90% credible intervals.
...
tar_pipeline(
  ...
  tar_target(
    data_continuous,
    map_dfr(seq_len(40), simulate_data_continuous),
...
<img src="./images/graph7.png" height = "400px">
...
<img src="./images/report2.png" height = "400px">

---

## Inspect the report

<img src="./images/report3.png" height = "400px">
