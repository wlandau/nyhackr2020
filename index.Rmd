...
1. Verify that in 95% of the simulation reps, the $\beta$ parameter values used for data generation are covered in 95% credible intervals.
...
## Only run the new outdated targets
